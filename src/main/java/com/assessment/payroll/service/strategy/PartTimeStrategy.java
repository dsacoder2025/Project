...
public class PartTimeStrategy implements PayStrategy {

    @Override
    public BigDecimal calculateGrossPay(Employee employee, BigDecimal workUnits) {
       
        BigDecimal cappedHours = workUnits.min(BigDecimal.valueOf(120));
        return employee.getPayRate().multiply(cappedHours);
    }
